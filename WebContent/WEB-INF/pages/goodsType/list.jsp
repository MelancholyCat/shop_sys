    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="pull-right">
                ...
                <a href="${pageContext.request.contextPath }/goodsType?method=editUI" class="btn btn-default" >添加</a>
            </div>
					...
					<c:forEach items="${pageResult.list}" var="item">
						<tr>
	                        ...
	                        <td>
	                            ...
	                            <a href="${pageContext.request.contextPath }/goodsType?method=delete&id=${item.gtId}" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-eye-open"></span>删除</a>
	                        </td>
	                    </tr>
					</c:forEach>
                </tbody>
            ...
            <div class="panel-footer clearfix">
                ...
                <nav class="pull-right">
                    <ul class="pagination pagination-self">
                    	...
                    	<c:if test="${pageResult.currentPage >1}">
                    		 <li>
	                            <a href="${pageContext.request.contextPath }/goodsType?method=list&currentPage=${pageResult.currentPage-1}" aria-label="Previous">
	                                <span aria-hidden="true">&laquo;</span>
	                            </a>
	                        </li>
                    	</c:if>
                        ...
                        <c:forEach begin="${pageResult.beginIndex }" end="${pageResult.endIndex }" varStatus="status">
                        	...
                        	<c:if test="${status.index ne pageResult.currentPage}">
                        		<li><a href="${pageContext.request.contextPath }/goodsType?method=list&currentPage=${status.index}">${status.index }</a></li>
                        	</c:if>
                        </c:forEach>
                        ...
                        <c:if test="${pageResult.currentPage < pageResult.totalPages}">
	                        <li>
	                            <a href="${pageContext.request.contextPath }/goodsType?method=list&currentPage=${pageResult.currentPage+1}" aria-label="Next">
	                                <span aria-hidden="true">&raquo;</span>
	                            </a>
	                        </li>
                        </c:if>
...
<script type="text/javascript">
	...
	function queryByPages(){
		...
		document.location.href="${pageContext.request.contextPath }/goodsType?method=list&currentPage=1&pageSize="+pageSize+"&goodsTypeName="+goodsTypeName;
	}
